...
import { RemoveRedEyeRoundedIcon, VisibilityOffRoundedIcon } from "../icons";
  ...
  const { values, errors, touched, handleBlur, handleChange, handleSubmit } =
    useFormik({
      ...
      onSubmit: async (values) => {
        ...
        const passwordData = { oldPassword, newPassword, confirmNewPassword };
        const action = await dispatch<any>(updatePassword(passwordData));
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4 h-[5rem]">
            ...
            <div className="relative">
              ...
              >
                {showOldPassword ? (
                  <RemoveRedEyeRoundedIcon className="w-6 h-6" />
                ) : (
                  <VisibilityOffRoundedIcon className="w-6 h-6" />
                )}
              </button>
            </div>
            {errors.oldPassword && touched.oldPassword && (
